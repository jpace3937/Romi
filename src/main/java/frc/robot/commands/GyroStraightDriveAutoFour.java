...
public class GyroStraightDriveAutoFour extends CommandBase {
   ...
   */
  public GyroStraightDriveAutoFour(Drivetrain s_Drivetrain, double xAxisSpeed) {
  ...
  public GyroStraightDriveAutoFour(Drivetrain s_Drivetrain, double xAxisSpeed, double angle) {
    this.s_Drivetrain = s_Drivetrain;
    this.xAxisSpeed = xAxisSpeed;
    addRequirements(s_Drivetrain);
    gyro = Robot.gyro;
