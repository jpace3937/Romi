...
public class GyroStraightDriveAutoTwo extends CommandBase {
   ...
   */
  public GyroStraightDriveAutoTwo(Drivetrain s_Drivetrain, double xAxisSpeed) {
  ...
  public GyroStraightDriveAutoTwo(Drivetrain s_Drivetrain, double xAxisSpeed, double angle) {
    this.s_Drivetrain = s_Drivetrain;
    this.xAxisSpeed = xAxisSpeed;
    addRequirements(s_Drivetrain);
    gyro = Robot.gyro;
